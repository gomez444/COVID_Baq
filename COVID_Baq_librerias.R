...
source(paste(path,'/COVID_Baq_organizador_datos.R',sep=''), chdir = TRUE)
source(paste(path,'/COVID_Baq_modelos_logisticos.R',sep=''), chdir = TRUE)
source(paste(path,'/COVID_Baq_funciones_estimacion.R',sep=''), chdir = TRUE)
source(paste(path,'/COVID_Baq_funciones_prediccion.R',sep=''), chdir = TRUE)
source(paste(path,'/COVID_Baq_modelos_SIR.R',sep=''), chdir = TRUE)
